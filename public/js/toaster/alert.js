    ...
    $.extend({
		...
		confirm:function(){
			...
			if(args.length){
				...
				d = $('<div class="alert_overlay"><div class="alert_msg"><div class="alert_content">'+args[0]+'</div><div class="alert_buttons"><button class="alert_btn alert_btn_ok">Ok</button><button class="alert_btn alert_btn_cancel">Cancel</button></div></div></div>').on('contextmenu',!1).on('click','.alert_btn_ok',{r:!0},_click).on('click','.alert_btn_cancel',{r:!1},_click)
